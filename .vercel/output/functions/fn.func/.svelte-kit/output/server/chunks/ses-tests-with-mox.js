...
const Ses_tests_with_mox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<p data-svelte-h="svelte-1nrjmxs">In my experience AWS SES offers little to no visibility into what emails are sending, how, when or to whom.
...
and configured correctly, they were.</p>`;
});
export {
  Ses_tests_with_mox as default,
  metadata
};
