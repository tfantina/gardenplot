import{s as i,n as a}from"./scheduler.c83dfd02.js";import{S as r,i as l,g as m,h as d,A as h,a as u,f as c}from"./index.bdcb1ddf.js";function w(s){let e,o=`In my experience AWS SES offers little to no visibility into what emails are sending, how, when or to whom.
...
and configured correctly, they were.`;return{c(){e=m("p"),e.textContent=o},l(t){e=d(t,"P",{"data-svelte-h":!0}),h(e)!=="svelte-1nrjmxs"&&(e.textContent=o)},m(t,n){u(t,e,n)},p:a,i:a,o:a,d(t){t&&c(e)}}}const p={title:"SES Tests with Mox",hero:"",alt:"Elixir Mox Library",daterange:"Jul 2022",date:"2022-07-30",tags:["Elixir","Phoenix","Mox","Bamboo"]};class x extends r{constructor(e){super(),l(this,e,null,w,i,{})}}export{x as default,p as metadata};
